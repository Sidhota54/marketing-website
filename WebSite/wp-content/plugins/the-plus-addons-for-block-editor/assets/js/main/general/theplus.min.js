...
h.each(n,function(a,b){h.fn.DataTable[a]=b});return h.fn.dataTable});!function(r){"use strict";r(".tpgb-table-wrapper").each(function(){var a,e,t,n,l,s,d=r(this);function i(){767<r(window).width()?(r(e).addClass("tpgb-column-rules"),r(e).removeClass("tpgb-no-column-rules")):(r(e).removeClass("tpgb-column-rules"),r(e).addClass("tpgb-no-column-rules"))}void 0!==d&&(a=d.find(".tpgb-table").data("id"),l=n=t=!1,0!=(e=d.find("#tpgb-table-id-"+a)).length&&("yes"==e.data("searchable")&&(t=!0),"yes"==e.data("show-entry")&&(n=!0),"yes"==e.data("sort-table")&&(e.find("th").css({cursor:"pointer"}),l=!0),s=e.data("searchable-label"),(t||n||l)&&(e.DataTable({paging:!1,searching:!1,ordering:l,info:!1,pagingType:"full_numbers",lengthMenu:[[5,10,15,-1],[5,10,15,"All"]],oLanguage:{sSearch:s}}),d.find(".dataTables_length").addClass("tpgb-tbl-entry-wrapper tpgb-table-info"),d.find(".dataTables_filter").addClass("tpgb-tbl-search-wrapper tpgb-table-info"),d.find(".tpgb-table-info").wrapAll('<div class="tpgb-advance-heading"></div>')),window.addEventListener("load",i),window.addEventListener("resize",i)))})}(jQuery);!function(){"use strict";document.querySelectorAll(".tpgb-dark-mode").forEach(function(t){t.classList.contains("dark-pos-fixed")&&document.body.insertAdjacentHTML("afterbegin",t.outerHTML)}),document.querySelectorAll(".tpgb-dark-mode").forEach(function(a){(a.dataset.saveCookies&&"true"===window.localStorage.getItem("tpgb_darkmode")||null===window.localStorage.getItem("tpgb_darkmode")&&a.dataset.matchOs&&window.matchMedia("(prefers-color-scheme: dark)").matches)&&(a.classList.add("darkmode-activated"),document.body.classList.add("tpgb-dark-active")),a.getElementsByClassName("tpgb-darkmode-toggle")[0].addEventListener("click",function(){var t,e;t=a,e=document.body,t.classList.contains("darkmode-activated")?t.classList.remove("darkmode-activated"):t.classList.add("darkmode-activated"),e.classList.contains("tpgb-dark-active")?(e.classList.remove("tpgb-dark-active"),t.dataset.saveCookies&&window.localStorage.setItem("tpgb_darkmode",!1)):(e.classList.add("tpgb-dark-active"),t.dataset.saveCookies&&window.localStorage.setItem("tpgb_darkmode",!0))})})}();!function(e){"use strict";e(".tpgb-external-form-styler .tpgb-contact-form-7").each(function(){var a="tpgb-cf7-checkbox",s=0;e(this).hasClass("tp-form-loaded")||(e(".wpcf7-form-control.wpcf7-radio .wpcf7-list-item",this).each(function(){var t=e(this).find(".wpcf7-list-item-label").text();e(this).find(".wpcf7-list-item-label").remove();var i=e('input[type="radio"]',this);i.parent().is("label")&&i.unwrap();i=e(this).find('input[type="radio"]').attr("name");e(this).append('<label class="input__radio_btn" for="'+i+s+'">'+t+'<div class="toggle-button__icon"><span class="tpgb-radiocf7-icon"><i class="fa fa-check" aria-hidden="true"></i></span></div></label>'),e(this).find('input[type="radio"]').attr("id",i+s),e(this).find('input[type="radio"]').addClass("input-radio-check"),e(this).parents(".wpcf7-form-control-wrap").addClass(a),s++}),s=0,e(".wpcf7-form-control.wpcf7-checkbox .wpcf7-list-item",this).each(function(){var t=e(this).find(".wpcf7-list-item-label").text();e(this).find(".wpcf7-list-item-label").remove();var i=e('input[type="checkbox"]',this);i.parent().is("label")&&i.unwrap(),e(this).append('<label class="input__checkbox_btn" for="'+a+s+'">'+t+'<div class="toggle-button__icon"><span class="tpgb-checkcf7-icon"><i class="fa fa-check" aria-hidden="true"></i></span></div></label>'),e(this).find('input[type="checkbox"]').attr("id",a+s),e(this).find('input[type="checkbox"]').addClass("input-checkbox-check"),e(this).parents(".wpcf7-form-control-wrap").addClass(a),s++}),e(".wpcf7-form-control-wrap input[type='file']",this).each(function(){var t=e(this).attr("name");e(this).attr("id",t+s),e(this).attr("data-multiple-caption","{count} files selected"),e(this).parents(".wpcf7-form-control-wrap").append('<label class="input__file_btn" for="'+t+s+'"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="17" viewBox="0 0 20 17"><path d="M10 0l-5.2 4.9h3.3v5.1h3.8v-5.1h3.3l-5.2-4.9zm9.3 11.5l-3.2-2.1h-2l3.4 2.6h-3.5c-.1 0-.2.1-.2.1l-.8 2.3h-6l-.8-2.2c-.1-.1-.1-.2-.2-.2h-3.6l3.4-2.6h-2l-3.2 2.1c-.4.3-.7 1-.6 1.5l.6 3.1c.1.5.7.9 1.2.9h16.3c.6 0 1.1-.4 1.3-.9l.6-3.1c.1-.5-.2-1.2-.7-1.5z"></path></svg><span>Choose a file…</span></label>'),e(this).parents(".wpcf7-form-control-wrap").addClass("cf7-style-file"),s++}),e(this).addClass("tp-form-loaded"))})}(jQuery);(function(a){"use strict";var b=document.querySelectorAll(".tpgb-adv-map");Array.prototype.forEach.call(b,function(b){var c=a(b),d=c.data("id"),e=c.data("map-settings"),f=null,g=null,h=null,j=null;if(!c.hasClass("map-loaded")){var k=[],l=function(){!1,g=new google.maps.LatLngBounds,f=new google.maps.Map(document.getElementById(d),e.options),h=new google.maps.InfoWindow;var b,c;for(f.setTilt(45),google.maps.event.addListener(h,"domready",function(){var b=a(".gm-style-iw"),c=b.prev(),d=b.parent("div");d.addClass("marker-icon");var e=b.next();e.hide(),b.addClass("marker-title")}),c=0;c<e.places.length;c++)j=new google.maps.LatLng(e.places[c].latitude,e.places[c].longitude),g.extend(j),b=new google.maps.Marker({position:j,map:f,title:e.places[c].address,icon:e.places[c].pin_icon}),google.maps.event.addListener(b,"click",function(a,b){return function(){1<e.places[b].address.length&&h.setContent("<div class=\"gmap_info_content\"><p>"+e.places[b].address+"</p></div>"),h.open(f,a)}}(b,c)),f.fitBounds(g);var k=google.maps.event.addListener(f,"idle",function(){this.setZoom(e.options.zoom),google.maps.event.removeListener(k)}),l=function(){google.maps.event.trigger(f,"resize"),f.setCenter(j)};l()},m=function(){for(var a=0,b=k.length;a<b;a++)k[a]()},n=function(){m()};k.push(l),n(),c.addClass("map-loaded")}})})(jQuery);/* Interactive Circle Info Start */
