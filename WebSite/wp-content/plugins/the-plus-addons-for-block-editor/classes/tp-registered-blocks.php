...
Class Tpgb_Library {
    ...
    public function get_plus_block_settings($block = null){
		...
		$plus_extras = array('content-hover-effect','tpgb-group-button','carouselSlider','countdown-style-1','tpgb-animation', 'tpgb-pagination', 'tpgb-caldera-form', 'tpgb-everest-form', 'tpgb-gravity-form', 'tpgb-wp-form', 'tpgb-draw-svg', 'tpgb-fancy-box', 'tpgb-row-column-link','tp-heading-title-split');
